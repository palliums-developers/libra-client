...
class Client(LibraClient):
    ...
    def add_liquidity(self, sender_account, min_liquidity, max_token_amount, violas_amount, token_module_address, token_module_name, exchange_module_address=None, is_blocking=True, **kwargs):
        args = []
    ...
    def publish_reserve(self, sender_account, token_module_address, token_module_name, exchange_module_address=None, is_blocking=True, **kwargs):
        args = []
    ...
    def remove_liquidity(self, sender_account, amount, min_violas, min_tokens, token_module_address, token_module_name, exchange_module_address=None, is_blocking=True, **kwargs):
        args = []
    ...
    def token_to_token_swap(self, sender_account, tokens_sold, min_tokens_bought, min_violas_bought,
            sold_token_module_address, sold_token_module_name, bought_token_module_address, bought_token_module_name, exchange_module_address=None, is_blocking=True, **kwargs):
        args = []
        ...
        sold_token_type = self.get_type_args(sold_token_module_address, sold_token_module_name)
        bought_token_type = self.get_type_args(bought_token_module_address, bought_token_module_name)
        ty_args = sold_token_type.extend(bought_token_type)
        script = Script.gen_script(CodeType.TOKEN_TO_TOKEN_SWAP, *args, ty_args=ty_args, module_address=self.get_exchange_module_address(exchange_module_address))
        return self.submit_script(sender_account, script, is_blocking, **kwargs)

    def token_to_violas_swap(self, sender_account, tokens_sold, min_violas, token_module_address, token_module_name, exchange_module_address=None, is_blocking=True, **kwargs):
        args = []
        args.append(TransactionArgument.to_U64(tokens_sold))
        args.append(TransactionArgument.to_U64(min_violas))
        args.append(TransactionArgument.to_U64(self.DEAD_LINE))
    ...
    def violas_to_token_swap(self, sender_account, violas_sold, min_tokens, token_module_address, token_module_name, exchange_module_name=None, is_blocking=True, **kwargs):
        args = []
        ...
        ty_args = self.get_type_args(token_module_address, token_module_name)
        script = Script.gen_script(CodeType.ADD_LIQUIDITY, *args, ty_args=ty_args, module_address=self.get_exchange_module_address(exchange_module_name))
        return self.submit_script(sender_account, script, is_blocking, **kwargs)
