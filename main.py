...
coins = ['Coin1', 'Coin2',  'VLSUSD', 'VLSEUR', 'VLSGBP', 'VLSJPY', 'VLSSGD', 'LBRUSD', 'LBREUR', 'LBRGBP', 'LBRJPY', 'LBRSGD', 'BTCBTC']
import time
...
#     client.add_currency_to_account(liquidity_account, coin, gas_currency_code="LBR")
#     client.mint_coin(liquidity_account.address, 100_000_000, auth_key_prefix=liquidity_account.auth_key_prefix, currency_code=coin, gas_currency_code="LBR")
#
# for i in range(0, len(coins)):
#     for cur in range(i+1, coin_len):
#         print(coins[i], coins[cur])
#         print(client.get_balances(liquidity_account.address))
#         client.swap_add_liquidity(liquidity_account, coins[i], coins[cur], 1000000, 1000000)
#
