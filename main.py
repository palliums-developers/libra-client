...
#
#
# def addLiquidity(ida, idb, amountADesired, amountBDesired, amountAMin, amountBMin, reserveA, reserveB,
...
#     print(addLiquidity(0, 1, 1 * 10 ** 29, 2 * 10 ** 29, 0, 0, 1 * 10 ** 30, 2 * 10 ** 30,
#                        1414213562373094995304885780480))
#     pairs = getPairs()
#     trades = bestTradeExactIn(pairs, 6, 0, 1 * 10 ** 18, 1 * 10 ** 18)
#     # trades = bestTradeExactIn(pairs, 6, 0, 1 * 10 ** 18, 1 * 10 ** 18)
#
#     print(trades)
#     # print("xxxxx")
