...
class Client(LibraClient):
    ...
    def borrow(self, sender_account, amount, data=None, currency_code=None, currency_module_address=None, bank_module_address=None, is_blocking=True, **kwargs):
        args = []
    ...
    def enter_bank(self, sender_account, amount, currency_code=None, currency_module_address=None, bank_module_address=None, is_blocking=True, **kwargs):
        args = []
        args.append(TransactionArgument.to_U64(amount))
    ...
    def exit_bank(self, sender_account, amount, currency_module_address=None, currency_code=None, bank_module_address=None, is_blocking=True, **kwargs):
        args = []
        args.append(TransactionArgument.to_U64(amount))
    ...
    def liquidate_borrow(self, sender_account, borrower, amount, data=None, currency_code=None, currency_module_address=None, collateral_module_address=None, collateral_module_name=None, bank_module_address=None, is_blocking=True, **kwargs):
        args = []
    ...
    def lock(self, sender_account, amount, data=None, currency_code=None, currency_module_address=None, bank_module_address=None, is_blocking=True, **kwargs):
        args = []
        args.append(TransactionArgument.to_U64(amount))
        args.append(TransactionArgument.to_U8Vector(data, hex=False))
    ...
    def redeem(self, sender_account, amount=0, data=None, currency_code=None, currency_module_address=None, bank_module_address=None, is_blocking=True, **kwargs):
        args = []
        args.append(TransactionArgument.to_U64(amount))
        args.append(TransactionArgument.to_U8Vector(data, hex=False))
    ...
    def register_token(self, bank_module_account, price_oracle, collateral_factor, tokendata=None, currency_code=None, currency_module_address=None, bank_module_address=None, is_blocking=True, **kwargs):
        args = []
    ...
    def repay_borrow(self, sender_account, amount=0, data=None, currency_code=None, currency_module_address=None, bank_module_address=None, is_blocking=True, **kwargs):
        args = []
        args.append(TransactionArgument.to_U64(amount))
        args.append(TransactionArgument.to_U8Vector(data, hex=False))
    ...
    def update_collateral_factor(self, sender_account, factor, currency_code=None, currency_module_address=None, bank_module_address=None, is_blocking=True, **kwargs):
        args = []
    ...
    def update_price(self, sender_account, price, currency_code=None, currency_module_address=None, bank_module_address=None, is_blocking=True, **kwargs):
    ...
    def get_lock_amount(self, account_address, currency_code=None, currency_module_address=None, bank_module_address=None):
        bank_module_address = self.get_bank_module_address(bank_module_address)
        state = self.get_account_state(bank_module_address)
        exchange_rate = state.get_exchange_rate(currency_code, currency_module_address)
        index = state.get_token_index(currency_code, currency_module_address)
        state = self.get_account_state(account_address)
        return state.get_lock_amount(index, exchange_rate, self.get_bank_module_address(bank_module_address))

    def get_cur_lock_rate(self, currency_code=None, currency_module_address=None, bank_module_address=None):
        bank_module_address = self.get_bank_module_address(bank_module_address)
        state = self.get_account_state(bank_module_address)
        return state.get_cur_lock_rate(currency_code, currency_module_address)

    def get_borrow_amount(self, account_address, currency_code=None, currency_module_address=None, bank_module_address=None, include_interest=True):
        bank_module_address = self.get_bank_module_address(bank_module_address)
        bank_module_address = self.get_bank_module_address(bank_module_address)
        state = self.get_account_state(bank_module_address)
        index = state.get_token_index(currency_code, currency_module_address)
    ...
    def get_cur_borrow_rate(self, currency_code=None, currency_module_address=None, bank_module_address=None):
        bank_module_address = self.get_bank_module_address(bank_module_address)
        state = self.get_account_state(bank_module_address)
        return state.get_cur_borrow_rate(currency_code, currency_module_address)

    def get_utilization(self, currency_code=None, currency_module_address=None, bank_module_address=None):
        bank_module_address = self.get_bank_module_address(bank_module_address)
        state = self.get_account_state(bank_module_address)
        return state.get_cur_borrow_rate(currency_code, currency_module_address)
